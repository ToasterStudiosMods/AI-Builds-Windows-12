 ...
 * include/font8x8.h — 8x8 bitmap font (ASCII 0x20..0x7E)
 *
 * Public-domain 8x8 font (the widely-used "font8x8_basic" glyph set). Each
 * glyph is 8 bytes, one per row top-to-bottom; within a row bit 0 (LSB) is the
 * leftmost pixel. Indexed directly by ASCII code; control chars are blank.
 * ==========================================================================*/

#ifndef AURELIAN_FONT8X8_H
#define AURELIAN_FONT8X8_H
