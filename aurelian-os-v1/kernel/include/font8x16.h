 ...
 * include/font8x16.h — 8x16 bitmap font (ASCII 0x20..0x7E)
 *
 * The classic VGA-style 8x16 cell: 16 rows per glyph, and within a row the
 * MOST significant bit is the leftmost pixel (bit 7 = column 0). Note this is
 * the opposite convention from font8x8.h.
 *
 * Metrics: cap height 10px (rows 2..11), baseline row 11, descenders rows
 * 12..14. Advance is 8px, so glyphs carry their own right side bearing.
 * ==========================================================================*/

#ifndef AURELIAN_FONT8X16_H
#define AURELIAN_FONT8X16_H
...
/* Indexed by (ch - 0x20) for 0x20..0x7E. */
...
/* 0x24 '$' */ {0x00,0x18,0x18,0x7C,0xC6,0xC2,0xC0,0x7C,0x06,0x86,0xC6,0x7C,0x18,0x18,0x00,0x00},
...
/* 0x6A 'j' */ {0x00,0x00,0x0C,0x0C,0x00,0x1C,0x0C,0x0C,0x0C,0x0C,0x0C,0xCC,0xCC,0x78,0x00,0x00},
